<?php 
    $this->layout("themes/architect-ui/_theme", [
        'title' => sprintf($dbUser ? _('Editar Resumo Operacional | %s') : _('Registrar Resumo Operacional | %s'), $appData['app_name'])
    ]);
?>

<?php 
    $this->insert('themes/architect-ui/components/title', [
        'title' => ($dbUser ? sprintf(_("Editar Resumo Operacional \"%s\""), $dbUser->name) : _('Registrar Resumo Operacional')),
        'subtitle' => $dbUser 
            ? _('Preencha os dados abaixo para alterar o resumo operacional, e então clique em "Atualizar Resumo Operacional"') 
            : _('Preencha os dados abaixo para registrar um resumo operacional, e então clique em "Registrar Resumo Operacional"'),
        'icon' => 'pe-7s-note2',
